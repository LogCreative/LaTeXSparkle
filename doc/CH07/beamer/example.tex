% The content
% To compile the beamer, please switch to example_beamer.tex:
% https://github.com/LogCreative/LaTeXSparkle/blob/master/doc/CH07/beamer/example_beamer.tex
%
% VS Code locate the main tex file
% by searching \begin{document}
